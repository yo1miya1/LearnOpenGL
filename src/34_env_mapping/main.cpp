...
int main(int argc, char* argv[])
{
    ...
    Shader skyboxShader("./src/shader/cube_map_vert.glsl", "./src/shader/cube_map_frag.glsl");
    Shader reflectShader("./src/shader/reflect_obj_vert.glsl", "./src/shader/reflect_obj_frag.glsl");
    Shader refractShader("./src/shader/refract_obj_vert.glsl", "./src/shader/refract_obj_frag.glsl");
